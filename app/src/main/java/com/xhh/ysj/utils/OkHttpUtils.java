...
import com.xhh.ysj.manager.RetrofitHttp;
...
public class OkHttpUtils {
    ...
    private void _postAsyn(final String url, final StringCallback callback, final String jsonEntity) {
//        if (!CommonUtil.isUrlAvailable(url)) {
//            callback.onFailure(ErrCodeConstant.ERR_UPLOAD_URL_INCORRECT, null, null);
//            return;
//        }
        if(null==jsonEntity){
            return;
...
//                    ops.inSampleSize = inSampleSize;
    ...
    public interface StringCallback {
        void onFailure(int errCode, Request request, IOException e);
