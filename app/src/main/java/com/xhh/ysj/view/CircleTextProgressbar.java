...
public class CircleTextProgressbar extends TextView {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.circle_text_progressbar);
        if (typedArray.hasValue(R.styleable.circle_text_progressbar_in_circle_color))
            inCircleColors = typedArray.getColorStateList(R.styleable.circle_text_progressbar_in_circle_color);
        else
