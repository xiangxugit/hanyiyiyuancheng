...
public class PopBuy extends PopupWindow {
    ...
    public PopBuy(BaseActivity activity, String payurl) {
        // 通过layout的id找到布局View
        this.activity = activity;
        this.payurl = payurl;

        View contentView = LayoutInflater.from(activity).inflate(R.layout.pop_no_money, null);
        // 获取PopupWindow的宽高
...
//        this.setAnimationStyle(R.style.PopWindowAnimStyle);
        ...
        middleico = (ImageView) contentView.findViewById(R.id.middle_ico);
