...
import com.xhh.ysj.media.AndroidMediaController;
import com.xhh.ysj.media.IRenderView;
import com.xhh.ysj.media.IjkVideoView;
...
public class IjkManager {
    ...
    public void setOnPlayerStateChangeListener(PlayerStateListener playerStateListener) {
    ...
    public IjkManager(final Activity activity, int resId) {
        try {
            ...
            LogUtils.e(TAG, "loadLibraries error: " + e);
        }
...
//        videoView.setMediaController(mMediaController);
        ...
        videoView.setOnErrorListener(new IMediaPlayer.OnErrorListener() {
            ...
            public boolean onError(IMediaPlayer mp, int what, int extra) {
                statusChange(STATUS_ERROR, what, extra);
        ...
        videoView.setOnInfoListener(new IMediaPlayer.OnInfoListener() {
            ...
            public boolean onInfo(IMediaPlayer mp, int what, int extra) {
                statusChange(STATUS_INFO, what, extra);
                /*switch (what) {
...
//        orientationEventListener.disable();
    ...
    private void onVolumeSlide(float percent) {
        ...
        LogUtils.d(TAG, "onVolumeSlide:" + s);
    }
    ...
    private void onProgressSlide(float percent) {
        ...
        if (showDelta != 0) {
            ...
            LogUtils.d(TAG, "onProgressSlide:" + text);
        }
    }
    ...
    private void onBrightnessSlide(float percent) {
        ...
        LogUtils.d(TAG, "brightness:" + brightness + ",percent:" + percent);
    ...
    public IjkManager playInFullScreen(boolean fullScreen) {
        if (fullScreen) {
            activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        }
        return this;
    ...
    public IjkManager onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public IjkManager onComplete(OnCompleteListener onCompleteListener) {
        this.onCompleteListener = onCompleteListener;
        return this;
    }

    public IjkManager onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public IjkManager onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener) {
     ...
     * @return
     */
    public IjkManager live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public IjkManager toggleAspectRatio() {
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
